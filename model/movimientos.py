...
class DepositoInternacional():
  def __init__(self, tipo:str, documento:str, motivo:float, monto:int, nombre1:str, nombre2:str, apellido1:str, apellido2:str, sexo:str, fechaNacimiento:str, lugarNacimiento:str, terminos:bool):
    self._tipo = tipo
    self._documento = documento
    self._motivo = motivo
    self._monto = monto
